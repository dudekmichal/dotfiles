" Vim color file - cyan
" Generated by http://bytefluent.com/vivify 2018-04-17
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi Folded guifg=#5fffff guibg=#080808 guisp=#080808 gui=NONE ctermfg=87 ctermbg=232 cterm=NONE
hi PreCondit guifg=#eeeeee guibg=#080808 guisp=#080808 gui=NONE ctermfg=255 ctermbg=232 cterm=NONE
hi Include guifg=#eeeeee guibg=#080808 guisp=#080808 gui=NONE ctermfg=255 ctermbg=232 cterm=NONE
hi Float guifg=#5fffff guibg=#080808 guisp=#080808 gui=NONE ctermfg=87 ctermbg=232 cterm=NONE
...
hi Todo guifg=#eeeeee guibg=#080808 guisp=#080808 gui=NONE ctermfg=255 ctermbg=232 cterm=NONE
...
hi Statement guifg=#00ffff guibg=#080808 guisp=#080808 gui=NONE ctermfg=14 ctermbg=232 cterm=NONE
hi SpellRare guifg=#5fffff guibg=#080808 guisp=#080808 gui=NONE ctermfg=87 ctermbg=232 cterm=NONE
hi Comment guifg=#585858 guibg=#080808 guisp=#080808 gui=NONE ctermfg=240 ctermbg=232 cterm=NONE
hi Character guifg=#5fffff guibg=#080808 guisp=#080808 gui=NONE ctermfg=87 ctermbg=232 cterm=NONE
hi Number guifg=#5fffff guibg=#080808 guisp=#080808 gui=NONE ctermfg=87 ctermbg=232 cterm=NONE
hi Boolean guifg=#bcbcbc guibg=#080808 guisp=#080808 gui=NONE ctermfg=250 ctermbg=232 cterm=NONE
hi Operator guifg=#00ffff guibg=#080808 guisp=#080808 gui=NONE ctermfg=14 ctermbg=232 cterm=NONE
hi Question guifg=#bcbcbc guibg=#080808 guisp=#080808 gui=NONE ctermfg=250 ctermbg=232 cterm=NONE
hi WarningMsg guifg=#5fffff guibg=#080808 guisp=#080808 gui=NONE ctermfg=87 ctermbg=232 cterm=NONE
...
hi Function guifg=#00ffff guibg=#080808 guisp=#080808 gui=NONE ctermfg=14 ctermbg=232 cterm=NONE
hi FoldColumn guifg=#bcbcbc guibg=#080808 guisp=#080808 gui=NONE ctermfg=250 ctermbg=232 cterm=NONE
hi PreProc guifg=#00ffff guibg=#080808 guisp=#080808 gui=NONE ctermfg=14 ctermbg=232 cterm=NONE
...
hi Tag guifg=#5fffff guibg=#080808 guisp=#080808 gui=NONE ctermfg=87 ctermbg=232 cterm=NONE
hi String guifg=#525252 guibg=#080808 guisp=#080808 gui=NONE ctermfg=239 ctermbg=232 cterm=NONE
...
hi condtional guifg=#5fffff guibg=#080808 guisp=#080808 gui=NONE ctermfg=87 ctermbg=232 cterm=NONE
