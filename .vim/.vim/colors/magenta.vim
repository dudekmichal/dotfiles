" Vim color file - magenta
" Generated by http://bytefluent.com/vivify 2018-06-28
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi Folded guifg=#54487a guibg=#080808 guisp=#080808 gui=NONE ctermfg=60 ctermbg=232 cterm=NONE
hi PreCondit guifg=#eeeeee guibg=#080808 guisp=#080808 gui=NONE ctermfg=255 ctermbg=232 cterm=NONE
hi Include guifg=#54487a guibg=#080808 guisp=#080808 gui=NONE ctermfg=60 ctermbg=232 cterm=NONE
hi Float guifg=#54487a guibg=#080808 guisp=#080808 gui=NONE ctermfg=60 ctermbg=232 cterm=NONE
...
hi DiffText guifg=#bcbcbc guibg=#53487a guisp=#53487a gui=NONE ctermfg=250 ctermbg=60 cterm=NONE
...
hi Todo guifg=#000000 guibg=#00ff00 guisp=#00ff00 gui=NONE ctermfg=NONE ctermbg=10 cterm=NONE
...
hi StatusLine guifg=#54487a guibg=#eeeeee guisp=#eeeeee gui=NONE ctermfg=60 ctermbg=255 cterm=NONE
...
hi Statement guifg=#53487a guibg=#080808 guisp=#080808 gui=NONE ctermfg=60 ctermbg=232 cterm=NONE
...
hi Character guifg=#54487a guibg=#080808 guisp=#080808 gui=NONE ctermfg=60 ctermbg=232 cterm=NONE
hi Number guifg=#00ff00 guibg=#080808 guisp=#080808 gui=NONE ctermfg=10 ctermbg=232 cterm=NONE
...
hi WarningMsg guifg=#54487a guibg=#080808 guisp=#080808 gui=NONE ctermfg=60 ctermbg=232 cterm=NONE
...
hi Function guifg=#00ff00 guibg=#080808 guisp=#080808 gui=NONE ctermfg=10 ctermbg=232 cterm=NONE
hi FoldColumn guifg=#bcbcbc guibg=#080808 guisp=#080808 gui=NONE ctermfg=250 ctermbg=232 cterm=NONE
hi PreProc guifg=#00ff00 guibg=#080808 guisp=#080808 gui=NONE ctermfg=10 ctermbg=232 cterm=NONE
...
hi Type guifg=#53487a guibg=#080808 guisp=#080808 gui=NONE ctermfg=60 ctermbg=232 cterm=NONE
...
hi Tag guifg=#54487a guibg=#080808 guisp=#080808 gui=NONE ctermfg=60 ctermbg=232 cterm=NONE
hi String guifg=#3d3d3d guibg=#080808 guisp=#080808 gui=NONE ctermfg=237 ctermbg=232 cterm=NONE
...
hi condtional guifg=#54487a guibg=#080808 guisp=#080808 gui=NONE ctermfg=60 ctermbg=232 cterm=NONE
